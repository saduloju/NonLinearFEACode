function [sig_n1,C_n1,ep_n1,beta_n1,a_n1,s_n1,Cdev_n1] = J2RadialReturn0(eps_n1,ep_n,beta_n,a_n,mu,bulk,K,H,sigy)
% Tim Truster
% 04/03/2012
...
if ftr_n1 <= 1e-12
   ...
   beta_n1 = beta_n + sqr23*dH*n_n1;
    ...
    a=R2G*th_n1*(I4 - R1/R3*OneOne)
    b=R2G*thbar_n1*(n_n1*n_n1')
    c=bulk*OneOne
